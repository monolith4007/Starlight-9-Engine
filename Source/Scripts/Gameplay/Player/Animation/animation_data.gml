...
switch (character_id)
{
    ...
    case CHAR_SONIC:
    {
        ...
        animation_set("SPINDASH",    spr_sonic_spindash,    0, 5,  0.8,   0, -1, "",          0);
        animation_set("SPRING",      spr_sonic_spring,      0, 0,  0,     0,  0, "",          0);
        animation_set("SKID",        spr_sonic_skid,        0, 2,  0.25,  2,  0, "SKID_TURN", 0);
        animation_set("SKID_TURN",   spr_sonic_skid_turn,   0, 0,  0.25,  0,  0, "",          0);
        animation_set("PUSH",        spr_sonic_push,        0, 4,  0.10,  1, -1, "",          0);
        ...
        animation_set("CORKSCREW",   spr_sonic_corkscrew,   0, 11, 0.05,  0,  0, "",          0);
        animation_set("BALANCE_1",   spr_sonic_balance,     0, 2,  0.15,  0, -1, "",          0);
        animation_set("BALANCE_2",   spr_sonic_balance_alt, 0, 2,  0.12,  0, -1, "",          0);
    ...
    case CHAR_TAILS:
    {
        ...
        animation_set("SPINDASH",    spr_tails_spindash,       0, 2,  0.5,   0, -1, "",          0);
        animation_set("SPRING",      spr_tails_spring,         0, 1,  0.1,   0, -1, "",          0);
        animation_set("SKID",        spr_tails_skid,           0, 1,  0.25,  1,  0, "SKID_TURN", 0);
        animation_set("SKID_TURN",   spr_tails_skid,           0, 1,  0.25,  0,  0, "",          0);
        ...
        animation_set("CORKSCREW",   spr_tails_corkscrew,      0, 11, 0.05,  0,  0, "",          0);
        ...
        animation_set("BALANCE_1",   spr_tails_balance,        0, 1,  0.15,  0, -1, "",          0);
    ...
    case CHAR_KNUCKLES:
    {
        ...
        animation_set("SPINDASH",    spr_knuckles_spindash,    0, 5,  0.8,   0, -1,  "",          0);
        animation_set("SPRING",      spr_knuckles_spring,      0, 0,  0,     0,  0,  "",          0);
        animation_set("SKID",        spr_knuckles_skid,        0, 1,  0.25,  1,  0,  "SKID_TURN", 0);
        animation_set("SKID_TURN",   spr_knuckles_skid,        1, 1,  0.25,  1,  0,  "",          0);
        ...
        animation_set("CORKSCREW",   spr_knuckles_corkscrew,   0, 11, 0.05,  0,  0,  "",          0);
        animation_set("BALANCE_1",   spr_knuckles_balance,     0, 11, 0,     8, -1,  "",          0);
    ...
    case CHAR_AMY:
    {
        ...
        animation_set("SPINDASH",     spr_amy_spindash,         0, 5,  0.8,   0, -1, "",           0);
        animation_set("SPRING",       spr_amy_spring,           0, 0,  0,     0,  0, "",           0);
        animation_set("SKID",         spr_amy_skid,             0, 2,  0.25,  2,  0, "SKID_TURN",  0);
        animation_set("SKID_TURN",    spr_amy_skid_turn,        0, 0,  0.25,  0,  0, "",           0);
        ...
        animation_set("CORKSCREW",    spr_amy_corkscrew,        0, 11, 0.05,  0,  0, "",           0);
        animation_set("BALANCE_1",    spr_amy_balance,          0, 4,  0.15,  0, -1, "",           0);
    ...
    case CHAR_MODERN:
    {
        ...
        animation_set("SPINDASH",    spr_modern_spindash,    0, 4,  0.8,   0, -1, "",          0);
        animation_set("SPRING",      spr_modern_spring,      0, 0,  0,     0,  0, "",          0);
        animation_set("SKID",        spr_modern_skid,        0, 2,  0.25,  2,  0, "SKID_TURN", 0);
        animation_set("SKID_TURN",   spr_modern_skid_turn,   0, 0,  0.25,  0,  0, "",          0);
        ...
        animation_set("CORKSCREW",   spr_modern_corkscrew,   0, 11, 0.05,  0,  0, "",          0);
        animation_set("BALANCE_1",   spr_modern_balance,     0, 2,  0.15,  0, -1, "",          0);
